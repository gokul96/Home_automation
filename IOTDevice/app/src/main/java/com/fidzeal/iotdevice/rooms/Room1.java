...
public class Room1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pDialog = new ProgressDialog(Room1.this);
    ...
    private void doRefresh() {
        ...
        if(IP.contentEquals("")){
            Toast.makeText(Room1.this,"Please set the IP address first",Toast.LENGTH_LONG).show();
            return;
        }
                ...
                if (result != null) {
                    try {
                        ...
                        if(status.contentEquals("success")){
                            Toast.makeText(Room1.this,"Success!",Toast.LENGTH_LONG).show();
                        }
                        else{
                            Toast.makeText(Room1.this,"Failure!",Toast.LENGTH_LONG).show();
                        }
                    }
                    catch (Exception e){
                        e.printStackTrace();
                    ...
                    Toast.makeText(Room1.this, "internal error!", Toast.LENGTH_SHORT).show();
                }
